...
| [`app/notes.py`](app/notes.py) | The shared `shared-notes` notebook, declared once: Agno mounts the full toolkit, the registry offers the scoped `shared_notes` functions to built components. |
